...
const packagesScopesLint = ['eslint-config-preset', 'eslint-config-react']
const packagesScopes = [
  ...
  {
    value: 'eslint-config-react',
    name: 'eslint-config-react                   eslint react项目规则',
  },
  {
    value: 'prettier-config-preset',
    name: 'prettier-config-preset                   prettier预制规则',
  },
  {
    value: 'other',
    name: 'other:                   其他，不确定选其他',
  },
]
